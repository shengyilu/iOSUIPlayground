...
public extension PopTip {
    ...
    class func borderPathWith(rect: CGRect, frame: CGRect, direction: PopTipDirection, arrowSize: CGSize, arrowPosition: CGPoint, borderWidth: CGFloat = 0, radius: CGFloat = 0) -> UIBezierPath {
        var path = UIBezierPath()
        var baloonFrame = CGRect.zero
